    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <p class="work-modal-title">{{__('main.text_10')}}</p>
                    <p class="work-modal-description"> {{__('main.text_11')}}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <p class="work-modal-title">{{__('main.text_12')}}</p>
                    <p class="work-modal-description"> {{__('main.text_13')}}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <p class="work-modal-title">{{__('main.text_14')}}</p>
                    <p class="work-modal-description">  {{__('main.text_15')}}
                    </p>
                </div>
            </div>
        </div>
